...
# chance to update.
CHANGELOG = [
    ("1.3.5", "the mic works on your own machine instead of waiting two minutes for hardware you don't have; the Room page loads; dashboard status is right again; security patches"),
